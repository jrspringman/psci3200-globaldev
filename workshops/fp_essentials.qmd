...
dat = dat %>% mutate(year = as.numeric(case_when(class_year == "Year I" ~ 1,
                                                 class_year == "Year II" ~ 2,
                                                 class_year == "Year III" ~ 3 )) )

models <- list()
models[['Simple']] = lm(z_participation_base ~ moved, dat)
models[['Interaction']] = lm(z_participation_base ~ moved*year, dat)
