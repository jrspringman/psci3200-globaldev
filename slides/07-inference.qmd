...
- For each plausible estimates of $\widehat{\beta}$ and $\widehat{\alpha}$ we can calculate the *prediction error*

\begin{equation*}
\hat{\smash{\varepsilon}}_i = Y_i - \hat{\alpha} - \hat{\beta} x_i
\end{equation*}
...
-   Statistical significance is important but it is NOT a measure of importance
