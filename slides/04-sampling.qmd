...
- However, we can't collect data on the entire population
...
- Need a sampling frame (list of every unit in the population)
  + Census, administrative records
  + Development research: often we have to create this ourselves on-the-ground
- Unit non-response
  + Selection
